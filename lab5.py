...
def getArticle(article_id):
    ...
    return render_template("articlescheck.html", article_text=text, article_title=articleBody[0], username=session.get("username"))
